...
import st from './DeveloperHome.less';
...
class DeveloperHome extends Component {
  ...
  render() {
    return (
      <div className={st.DeveloperHome}>
        <canvas id="canvas" />
        ...
        <div className={st.right}>
          <div className={st.bg} />
          <div className={st.ct}>
            <div className={st.selectpanel}>
              <div className={st.dlql}>
                <Link to="/developer/dlql" />
              </div>
              <div className={st.xqly}>
                <Link to="/developer/xqly" />
              </div>
              <div className={st.mph}>
                <Link to="/developer/mph" />
              </div>
            </div>
