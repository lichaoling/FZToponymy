...
let //**************** *行政区划*******************
  ...
  url_SearchWorkFlowLines_Road = `${baseUrl}/Road/SearchWorkFlowLines`, //查询一条道路、桥梁数据的所有流程节点，用于显示流程进度（string id）
  ...
  url_SearchWorkFlowLines_House = `${baseUrl}/House/SearchWorkFlowLines`, //查询一条小区楼宇的所有流程节点，用于显示流程进度（string id）
  url_SearchHouses = `${baseUrl}/House/SearchHouses`, //查询已审批或者待审批的小区楼宇数据(int pageNum, int pageSize, string districtID, int approvalState, DateTime? start, DateTime? end)//显示字段为：序号、行政区划、小区名称、所属道路、建筑面积、审批时间
  ...
  url_SearchWorkFlowLines_HouseBZ = `${baseUrl}/HouseBZ/SearchWorkFlowLines`, //查询一条住宅门牌编制的所有流程节点，用于显示流程进度（string id）
  url_HouseAndBuildingBZ = `${baseUrl}/HouseBZ/HouseAndBuildingBZ`, //住宅门牌号申请(string mObj, string workFlowID = "3")
  url_SearchHousesBZToProve = `${baseUrl}/HouseBZ/SearchHousesBZToProve`, //查询已审批或者待审批的住宅门牌号数据(int pageNum, int pageSize, string districtID, int approvalState, DateTime? start, DateTime? end) //显示字段为：序号、行政区划、小区名称、所属道路、审批时间
